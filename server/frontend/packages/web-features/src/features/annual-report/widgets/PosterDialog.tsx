...
export function PosterDialog({ data, open, onClose, url }: PosterDialogProps) {
  ...
  const link = url || (typeof window !== 'undefined' ? window.location.origin : 'https://your-server:8888')
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      a.href = dataUrl
      a.download = `smartbook-${data.year}-${data.ledgerName.replace(/\s+/g, '-')}.png`
      a.click()
    } catch (e) {
              ...
              <div className="relative z-10 flex h-full flex-col px-6 py-7">
                ...
                <div className="flex items-end justify-between">
                  <div className="flex flex-col">
                    ...
                    <span className="text-sm font-bold text-amber-300">SmartBook</span>
