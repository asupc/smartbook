...
export function AdminBackupPage() {
  ...
  const TAB_STORAGE_KEY = 'smartbook.web.adminBackup.tab'
  ...
  return (
    <Card
      size="small"
      title={<span className="text-base">{t('backup.title')}</span>}
