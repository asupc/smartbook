...
import { formatIsoDateTime } from '@smartbook/web-features'
    ...
    <div className="space-y-6">
      <Card size="small" styles={{ body: { padding: 24 } }}>
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <Button size="small" icon={<RefreshCcw className="h-3.5 w-3.5" />} onClick={onRefresh}>
      ...
      {isAdmin && !adminOverview ? (
        <Card size="small">
          <p className="py-4 text-center text-sm text-muted-foreground">{t('table.empty')}</p>
        </Card>
      ) : null}
