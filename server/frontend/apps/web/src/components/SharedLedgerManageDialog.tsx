...
export function SharedLedgerManageDialog({
  ...
  return (
    <Modal
      ...
      footer={[
        <Button key="close" variant="outlined" onClick={() => onOpenChange(false)}>
          {t('common.close')}
        </Button>,
      ]}
    >
            ...
            <section>
              ...
              <div className="mb-3 flex items-end gap-2">
                <div className="flex-1">
                  <label className="text-xs" style={fieldLabelStyle}>
                    {t('sharedLedger.inviteExpires')}
                  </label>
                  <Select
                    value={expiresHours}
                    onChange={(value) => setExpiresHours(value)}
                    options={[
                      { value: '1', label: `1 ${t('sharedLedger.hour')}` },
                      { value: '24', label: `24 ${t('sharedLedger.hour')}` },
                      { value: '72', label: `3 ${t('sharedLedger.day')}` },
                      { value: '168', label: `7 ${t('sharedLedger.day')}` },
                    ]}
                    style={{ width: '100%' }}
                  />
                </div>
