import type { AppSection } from '@smartbook/web-features'

export type { AppSection } from '@smartbook/web-features'
...
export function parseRoute(pathname: string): AppRoute {
  ...
  if (parts[1] === 'admin') {
    ...
    if (parts[2] === 'duplicate-transactions')
      return { kind: 'app', ledgerId: '', section: 'admin-duplicate-transactions' }
    return { kind: 'app', ledgerId: '', section: DEFAULT_APP_SECTION }
  }
  if (parts[1] === 'settings') {
...
export function routePath(route: AppRoute): string {
  ...
  switch (route.section) {
    ...
    case 'admin-duplicate-transactions':
      return '/app/admin/duplicate-transactions'
    case 'import':
      return '/app/import'
  }
}
