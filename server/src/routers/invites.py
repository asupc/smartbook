...
def _share_url_for(code: str) -> str:
    ...
    域名走 settings.invite_share_origin 配置,未配置时回退到 SmartBook 官网默认。
    """
...
def create_invite(
    ...
    metrics.inc("smartbook_shared_ledger_invites_created_total")
    logger.info(
...
def revoke_invite(
    ...
    metrics.inc("smartbook_shared_ledger_invites_revoked_total")
    logger.info(
...
async def accept_invite(
    ...
    metrics.inc("smartbook_shared_ledger_invites_accepted_total")
