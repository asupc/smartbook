...
class AIAnalysisLog(Base):
    ...
    写失败静默(services/ai/analysis_log.py),不影响 AI 主流程。
    """
...
class Ledger(Base):
    ...
    # 口径与决策见 SmartBook 仓 .docs/period-start-date/design.md。
...
class UserExchangeRateProjection(Base):
    ...
    原样保留,App apply 端按币对收敛(SmartBook 仓 02-tech-design-app §七)。
    """
