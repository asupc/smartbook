...
import 'package:smartbook/providers/currency_providers.dart';
import 'package:smartbook/providers/database_providers.dart';
import 'package:smartbook/services/currency/exchange_rate_service.dart';
...
void main() {
  ...
  test('extraQuotes:手选币种(JPY)不在使用中币种里,refresh 后其汇率被落库', () async {
    ...
    final container = ProviderContainer(overrides: [
      ...
      // smartbookCloudProviderInstance 走真实 provider 链会因未配置返回 null →
