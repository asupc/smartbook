...
import 'package:smartbook/data/db.dart' show Account, Category, Transaction;
import 'package:smartbook/data/repositories/budget_repository.dart'
    show BudgetOverview, BudgetUsage, CategoryBudgetUsage;
import 'package:smartbook/widget/views/budget_view.dart';
import 'package:smartbook/widget/views/dashboard_view.dart';
import 'package:smartbook/widget/views/glance_view.dart';
import 'package:smartbook/widget/views/net_worth_view.dart';
import 'package:smartbook/widget/views/quick_add_view.dart';
import 'package:smartbook/widget/views/recent_view.dart';
import 'package:smartbook/widget/widget_data_service.dart'
    show
        DashboardWidgetData,
        GlanceWidgetData,
        NetWorthAccountItem,
...
import 'package:smartbook/widget/widget_spec.dart' show HWSize;
...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      // Android 语言目录 → ios/SmartBookWidget/Previews/<base>_{zh,en}.png,
      // 避免双份资产漂移(iOS 那份最初是手工拷的快照,现在随生成器自动同步)。
      const iosDir = 'ios/SmartBookWidget/Previews';
