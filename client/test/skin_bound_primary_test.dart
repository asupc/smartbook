...
import 'package:smartbook/providers/sync_providers.dart' show resolvePrimaryFromSync;
import 'package:smartbook/providers/theme_providers.dart';
import 'package:smartbook/styles/header_skins.dart';
import 'package:smartbook/widgets/ui/skin_animation_scope.dart';
...
void main() {
  ...
  group('下行 apply 的 echo 抑制', () {
    ...
    // 横跳。这正是「一岁星座 + 开 SmartBook Cloud 主题色一直闪」的成因:
