...
Sync via SmartBook Cloud (self-hosted) / iCloud / Supabase / WebDAV / S3
...
<a href="https://play.google.com/store/apps/details?id=com.smartbook.zhi">
...
[🌐 Website](https://count.beejz.com/en/) · [📖 Docs](https://count.beejz.com/en/docs/intro) · [💝 Donate](#-donate) · [💬 Telegram](https://t.me/smartbook) · [📦 APK](https://github.com/TNT-Likely/BeeCount/releases/latest) · [🚀 TestFlight](https://testflight.apple.com/join/Eaw2rWxa)

</div>

---

> 🤖 **New: [MCP](https://count.beejz.com/en/docs/mcp) support** — pair with [SmartBook Cloud](https://github.com/TNT-Likely/BeeCount-Cloud) to drive your ledger from any MCP client.
...
> **Platform support**: 🤖 Android 5.0+ · 🍎 iOS 15.5+ · 🌐 Web (built into SmartBook Cloud, see below)
>
> ~~📱 HarmonyOS — [Discontinued](https://github.com/TNT-Likely/smartbook-openharmony)~~
...
SmartBook offers 5 sync options. Your data, your control. **See [docs/cloud-setup_EN.md](docs/cloud-setup_EN.md) for full setup guides.**

| Option | Best For | Highlights |
|---|---|---|
| **SmartBook Cloud** | Real-time multi-device + self-hosted + multi-user co-write | One-click Docker, sub-second sync, built-in Web, multi-user, **shared ledgers** |
...
**[👉 SmartBook-Cloud repo — One-click Docker deploy + full docs](https://github.com/TNT-Likely/BeeCount-Cloud)**
...
- **Supabase / Self-hosted SmartBook Cloud / WebDAV / S3** · Multi-option cloud sync
...
- Cross-platform + real-time multi-device → **SmartBook Cloud** (self-hosted, recommended)
- Cross-platform without NAS → **Supabase / S3**
- Have a NAS → **WebDAV**

**Q: How is data security ensured?**
A: Use your own server / Storage / Bucket. WebDAV and S3 should use HTTPS. SmartBook Cloud backups are AES-256 encrypted by default.
...
SmartBook is completely free and open-source — **no ads, no paid features**. If you find it useful, buy the developer a coffee ☕ to support continued development.
...
|---|---|
| [SmartBook-Cloud](https://github.com/TNT-Likely/BeeCount-Cloud) | Self-hosted sync server + Web admin (FastAPI + React) |
| [BeeCount-Website](https://github.com/TNT-Likely/BeeCount-Website) | Website / docs repo |
| [smartbook-openharmony](https://github.com/TNT-Likely/smartbook-openharmony) | HarmonyOS version (discontinued) |
...
Thanks to everyone who has contributed code, suggestions, or feedback to SmartBook!
...
**SmartBook 🐝 — Making accounting simple and secure**
