...
- Telegram: [加入讨论群](https://t.me/smartbook)
...
```bash
git clone https://github.com/你的用户名/SmartBook.git
cd SmartBook
```
...
智记官方维护 3 种语言（简体中文、繁体中文、English），并接受社区贡献的其他语言翻译。欢迎贡献新语言或改进现有翻译。
