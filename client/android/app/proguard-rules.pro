...
-keep class com.smartbook.zhi.NotificationReceiver { *; }
-keep class com.smartbook.zhi.NotificationClickReceiver { *; }
-keep class com.smartbook.zhi.MainActivity { *; }

# Keep all BroadcastReceiver subclasses
-keep public class * extends android.content.BroadcastReceiver

# Keep notification-related methods
-keepclassmembers class com.smartbook.zhi.** {
