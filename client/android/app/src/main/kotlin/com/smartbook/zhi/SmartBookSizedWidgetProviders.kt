...
/** 净资产·中(默认 4×2)。 */
class SmartBookNetWorthMediumWidgetProvider : SmartBookNetWorthWidgetProvider()

/** 净资产·大(默认 4×4)。 */
class SmartBookNetWorthLargeWidgetProvider : SmartBookNetWorthWidgetProvider()

/** 预算进度·中(默认 4×2)。 */
class SmartBookBudgetMediumWidgetProvider : SmartBookBudgetWidgetProvider()

/** 快速记账·中(默认 4×2)。 */
class SmartBookQuickAddMediumWidgetProvider : SmartBookQuickAddWidgetProvider()

/** 最近交易·大(默认 4×4)。 */
class SmartBookRecentLargeWidgetProvider : SmartBookRecentWidgetProvider()
