 ...
 */
open class SmartBookBudgetWidgetProvider : HomeWidgetProvider() {
    companion object {
        private const val TAG = "SmartBookBudgetWidget"
        ...
        appWidgetIds.forEach { widgetId ->
            try {
                ...
                val views = RemoteViews(context.packageName, R.layout.budget_widget).apply {
                    ...
                    try {
                        val intent = createLaunchIntentWithDeepLink(context, "smartbook://open?page=budget")
