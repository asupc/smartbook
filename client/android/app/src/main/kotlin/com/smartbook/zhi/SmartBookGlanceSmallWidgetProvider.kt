 ...
 * [SmartBookWidgetProvider](中号)加尺寸分档:老 provider 承载着存量用户
 * 已放置的组件(D2 back-compat,零改动原则),小号作为补全新增单独成类,
 * 互不影响。
 */
class SmartBookGlanceSmallWidgetProvider : HomeWidgetProvider() {
    companion object {
        private const val TAG = "SmartBookGlanceSmall"
