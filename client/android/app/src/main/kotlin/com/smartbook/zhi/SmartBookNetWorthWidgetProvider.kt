 ...
 * 缩放档位都有现成图可显。
 */
open class SmartBookNetWorthWidgetProvider : HomeWidgetProvider() {
    companion object {
        private const val TAG = "SmartBookNetWorthWidget"
        ...
        appWidgetIds.forEach { widgetId ->
            try {
                ...
                val views = RemoteViews(context.packageName, R.layout.net_worth_widget).apply {
                    ...
                    try {
                        val intent = createLaunchIntentWithDeepLink(context, "smartbook://open?page=assets")
