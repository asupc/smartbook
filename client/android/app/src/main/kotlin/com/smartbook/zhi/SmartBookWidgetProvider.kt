...
class SmartBookWidgetProvider : HomeWidgetProvider() {
    companion object {
        private const val TAG = "SmartBookWidget"
    }
    ...
    override fun onUpdate(
        ...
        appWidgetIds.forEach { widgetId ->
            try {
                ...
                val views = RemoteViews(context.packageName, R.layout.smartbook_widget).apply {
                    ...
                    // 右侧区域 → 打开收入记账
                    try {
                        val incomeIntent = createLaunchIntentWithDeepLink(context, "smartbook://new?type=income")
