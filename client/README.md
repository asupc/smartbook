# 智记(SmartBook) &nbsp; [English](README_EN.md)

> **原创声明**:本项目为开源项目 **[BeeCount](https://github.com/TNT-Likely/BeeCount)**(作者:sunxiao / GitHub: TNT-Likely)的下游二开版本,致谢原作者的慷慨开源与授权。源码许可沿用上游原协议(见 [LICENSE](LICENSE) / [LICENSE_EN](LICENSE_EN)),二开修改清单见仓库根目录 `README.md`.
...
支持 SmartBook Cloud 自建云端 / iCloud / Supabase / WebDAV / S3 五种同步方案
...
[🌐 官网](https://count.beejz.com) · [📖 文档](https://count.beejz.com/docs/intro) · [💝 捐赠](#-捐赠支持) · [💬 Telegram](https://t.me/smartbook) · [📦 APK](https://github.com/TNT-Likely/BeeCount/releases/latest) · [🚀 TestFlight](https://testflight.apple.com/join/Eaw2rWxa)

</div>

---

> 🤖 **新:[MCP](https://count.beejz.com/docs/mcp) 支持** — 搭配 [SmartBook Cloud](https://github.com/TNT-Likely/BeeCount-Cloud),用 LLM 直接管账本。
...
> **平台支持**:🤖 Android 5.0+ · 🍎 iOS 15.5+ · 🌐 Web(SmartBook Cloud 自带,见下文)
>
> ~~📱 HarmonyOS — [已停止更新](https://github.com/TNT-Likely/smartbook-openharmony)~~
...
智记提供 5 种同步方案,所有方案数据完全由你掌控,**详细配置教程见 [docs/cloud-setup.md](docs/cloud-setup.md)**。

| 方案 | 适用场景 | 特点 |
|---|---|---|
| **SmartBook Cloud** | 多端实时协同 + 自托管 + 多人共账 | Docker 一键、秒同步、自带 Web 端、多用户、**共享账本** |
...
**[👉 SmartBook-Cloud 仓库 — 一键 Docker 部署 + 完整文档](https://github.com/TNT-Likely/BeeCount-Cloud)**
...
- **Supabase / 自建 SmartBook Cloud / WebDAV / S3** · 云端同步多方案
...
A:
- iOS 单设备 → **iCloud**(零配置)
- 跨平台 + 多端实时协同 → **SmartBook Cloud**(自托管,推荐)
- 跨平台无 NAS → **Supabase / S3**
- 有 NAS → **WebDAV**

**Q: 如何确保数据安全?**
A: 使用自己的服务器 / Storage / Bucket,WebDAV 和 S3 建议 HTTPS 加密传输。SmartBook Cloud 备份默认 AES-256 加密。
...
智记完全免费开源,**无广告无付费功能**。如果觉得有用,请作者喝杯咖啡 ☕ 支持持续开发。
...
| 仓库 | 说明 |
|---|---|
| [SmartBook-Cloud](https://github.com/TNT-Likely/BeeCount-Cloud) | 自建云同步服务端 + Web 管理端(FastAPI + React) |
| [BeeCount-Website](https://github.com/TNT-Likely/BeeCount-Website) | 官网 / 文档仓库 |
| [smartbook-openharmony](https://github.com/TNT-Likely/smartbook-openharmony) | 鸿蒙版本(已停止更新) |
