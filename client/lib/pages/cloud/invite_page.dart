...
class _InvitePageState extends ConsumerState<InvitePage> {
  ...
  SmartBookCloudInvite? _generated;
  bool _busy = false;
  String? _error;
  ...
  Future<void> _share(SmartBookCloudInvite invite, AppLocalizations l10n) async {
  ...
  Widget _buildShareView(SmartBookCloudInvite invite, AppLocalizations l10n) {
    return SectionCard(
      child: Column(
          crossAxisAlignment: CrossAxisAlignment.stretch,
          children: [
