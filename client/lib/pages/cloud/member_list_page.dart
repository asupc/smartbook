...
import '../../providers/sync_providers.dart' show smartbookCloudProviderInstance;
...
class MemberListPage extends ConsumerWidget {
  ...
  Widget _buildList(
    ...
    WidgetRef ref,
    List<SmartBookCloudLedgerMember> members,
  ...
  Future<void> _confirmRemove(
    BuildContext context,
    WidgetRef ref,
    SmartBookCloudLedgerMember target,
    AppLocalizations l10n,
  ) async {
...
class _MemberTile extends ConsumerWidget {
  ...
  final SmartBookCloudLedgerMember member;
  final bool amOwner;
...
class _MemberAvatar extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final cloudAsync = ref.watch(smartbookCloudProviderInstance);
