...
class _ConfigImportExportPageState
  ...
  Future<Directory> _getExportDirectory() async {
    if (Platform.isAndroid) {
      // Android: 保存到公共 Download/SmartBook 目录
      final downloadPath = '/storage/emulated/0/Download/SmartBook';
  ...
  Future<void> _exportConfig() async {
    ...
    try {
      ...
      final fileName = 'smartbook_config_$timestamp.yml';

      if (Platform.isAndroid) {
        // Android: 直接保存到 Download/SmartBook 目录
