...
import '../data/privacy_panel_page.dart';
                  ...
                  child: Column(
                    children: [
                      ...
                      AppListTile(
                        ...
                        title: AppLocalizations.of(context).privacyPanelTitle,
                        subtitle:
                            AppLocalizations.of(context).privacyPanelDesc,
                        onTap: () async {
                          await Navigator.of(context).push(
                            MaterialPageRoute(
                                builder: (_) => const PrivacyPanelPage()),
                          );
                        },
                      ),
                    ],
