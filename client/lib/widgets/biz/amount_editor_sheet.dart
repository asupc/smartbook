...
import 'package:smartbook/widgets/ui/wheel_date_picker.dart';
import '../../data/db.dart';
...
class _TxAuthorInfo {
  ...
  final List<SmartBookCloudLedgerMember> members;

  SmartBookCloudLedgerMember? memberOf(String? userId) {
...
class _TxAuthorAvatars extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final cloud = ref.watch(smartbookCloudProviderInstance).valueOrNull;
