...
extension SyncEngineRealtime on SyncEngine {
  ...
  Future<void> _handleMemberChange(SmartBookCloudRealtimeEvent event) async {
  ...
  Future<void> _handleSharedResourceChange(SmartBookCloudRealtimeEvent event) async {
    final ledgerExternalId = event.ledgerId;
    if (ledgerExternalId == null || ledgerExternalId.isEmpty) return;
  ...
  Future<void> _downloadCustomIconsForSharedSnapshot(
      SmartBookCloudSharedResources snapshot) async {
