...
class UpdateChecker {
  ...
  ///   - smartbook-<ver>.apk             主分发(arm64-v8a,99% 现役真机)
  ///   - smartbook-<ver>-armeabi-v7a.apk armv7 老 32-bit 设备
  ///   - smartbook-<ver>-x86_64.apk      Intel/Win/Linux 模拟器
  ///   - smartbook-<ver>-universal.apk   三 ABI 全打,兜底
  ///
  ...
  ///
  /// 选择策略(按优先级):
  ///   1. `smartbook-<ver>.apk` 主包(arm64)— 现役真机 99% 是 arm64
  ...
  static String? _pickApkUrl(List assets, String version) {
    ...
    final mainPkgName = 'smartbook-$version.apk';
    final universalName = 'smartbook-$version-universal.apk';
