...
class AppLocalizationsZhTw extends AppLocalizationsZh {
  ...
  @override
  String get voiceRecordingPermissionDeniedMessage => '語音記帳功能需要使用麥克風權限。請在系統設定中允許智記存取麥克風。';
  ...
  @override
  String get analyticsCustom => '自訂';

  @override
  String get analyticsCompareLastMonth => '較上月';

  @override
  String get analyticsCompareSameMonthLastYear => '較去年同月';

  @override
  String get analyticsCompareLastYear => '較去年';

  @override
  String get analyticsComparePrevPrevYear => '較前年';

  @override
  String get analyticsAccountBreakdown => '帳戶分佈';

  @override
  String get analyticsTopMerchants => '商戶 Top';

  @override
  String get analyticsNoAccount => '未指定帳戶';
  ...
  @override
  String get mineShareWithFriends => '和好友分享智記';
  ...
  @override
  String get sharePosterAppName => '智記';
  ...
  @override
  String get shareGuidanceCopyText => '用智記記錄生活，開源免費無廣告！🐝 下載地址：https://github.com/TNT-Likely/BeeCount';
  ...
  @override
  String get categoryShareSubject => '智記 分類配置';
  ...
  @override
  String get cloudWebdavPathHint => '/智記';
  ...
  @override
  String get exportJsonButton => 'JSON 結構化匯出(備份)';

  @override
  String get privacyPanelTitle => '隱私面板';

  @override
  String get privacyPanelDesc => '原文資料保留策略與一鍵清理';

  @override
  String get privacyStatsAttachments => '截圖/圖片原文';

  @override
  String privacyStatsAttachmentsDesc(Object count, Object size) {
    return '$count 個檔案,佔用 $size';
  }

  @override
  String privacyStatsPending(Object count) {
    return '待確認候選:$count 項';
  }

  @override
  String get privacyNoOriginalForSmsNotifyTitle => '簡訊/通知原文不落盤';

  @override
  String get privacyNoOriginalForSmsNotifyDesc => '簡訊與支付通知原文在 AI 解析後即丟棄,不持久化(設計保證);僅保留解析出的結構化交易。';

  @override
  String get privacyClearAttachments => '一鍵清除截圖/圖片原文';

  @override
  String get privacyClearAttachmentsConfirmTitle => '確認清除原文?';

  @override
  String privacyClearAttachmentsConfirmBody(Object count) {
    return '將刪除 $count 個截圖/圖片原文檔案,不影響交易記錄與統計。建議先匯出備份。';
  }

  @override
  String privacyCleared(Object count) {
    return '已清除 $count 個原文檔案(交易資料保留)';
  }
  ...
  @override
  String get exportShareText => '智記 匯出檔案';
  ...
  @override
  String get updateNotificationGuideStep2 => '找到\\\"智記\\\"應用程式';
  ...
  @override
  String get cloudSmartBookCloudTitle => '智記';

  @override
  String get cloudSmartBookCloudSubtitle => '自建雲服務 · 增量同步 · 多裝置協同';

  @override
  String get cloudConfigureSmartBookCloudTitle => '設定智記';

  @override
  String get cloudSmartBookCloudUrlLabel => '伺服器地址';

  @override
  String get cloudSmartBookCloudUrlHint => 'https://your-server.com';

  @override
  String get cloudSmartBookCloudApiPrefixLabel => 'API 前綴';

  @override
  String get cloudSmartBookCloudApiPrefixHint => '/api/v1';

  @override
  String get cloudSmartBookCloudEmailLabel => '電子郵件';

  @override
  String get cloudSmartBookCloudEmailHint => 'your@email.com';

  @override
  String get cloudSmartBookCloudPasswordLabel => '密碼';

  @override
  String get cloudSmartBookCloudPasswordHint => '輸入密碼';

  @override
  String get cloudSmartBookCloudLoginSuccess => '登入成功';

  @override
  String get cloudSmartBookCloudLoginFailed => '登入失敗';

  @override
  String get cloudSmartBookCloudSyncSubtitle => '增量同步 · 多裝置協同';

  @override
  String get cloudSmartBookCloudConnected => '已連接';

  @override
  String get cloudSmartBookCloudNotConnected => '未連接';

  @override
  String get cloudSmartBookCloudNotConnectedHint => '請先在雲服務設定中配置並登入';

  @override
  String get cloudSmartBookCloudAutoSync => '增量同步';

  @override
  String get cloudSmartBookCloudAutoSyncHint => '資料變更自動同步到雲端，無需手動操作';

  @override
  String get cloudSmartBookCloudMultiDevice => '多裝置協同';

  @override
  String get cloudSmartBookCloudMultiDeviceHint => '多台裝置間自動保持資料一致';

  @override
  String get cloudSmartBookCloudAttachment => '附件同步';

  @override
  String get cloudSmartBookCloudAttachmentHint => '帳單圖片等附件自動雲端備份';
  ...
  @override
  String get accountInitialBalanceLocked => '初始值建立後不可修改，如需調整請使用「調整餘額」';

  @override
  String get accountAdjustBalanceLabel => '調整餘額';

  @override
  String get accountAdjustBalanceHint => '輸入調整後的目前餘額（如與銀行對帳單核對）';
  ...
  @override
  String get accountAdjustBalanceSame => '餘額與輸入一致，無需調整';

  @override
  String get accountAdjustBalanceNewValue => '調整後餘額';

  @override
  String get accountAdjustBalanceUpdate => '確認更新';

  @override
  String get accountAdjustBalanceInvalid => '請輸入有效的金額';
  ...
  @override
  String get welcomeTitle => '歡迎使用智記';
  ...
  @override
  String get welcomeCloudSyncDescription => '智記 支援多種同步方式，資料完全由你掌控';

  @override
  String get welcomeCloudSyncFeature1 => '完全離線使用，無需雲端服務';

  @override
  String get welcomeCloudSyncFeature2 => '智記 自建雲（多裝置即時協同 + Web 端）';
  ...
  @override
  String get iosWidgetStep3 => '搜索並選擇\"智記\"';
  ...
  @override
  String get androidWidgetStep3 => '找到並長按\"智記\"小組件';
  ...
  @override
  String get widgetQuickEntryDesc => '點擊小組件左側區域可快速新建支出，點擊右側區域可快速新建收入。也可透過捷徑使用 smartbook://new?type=transfer 快速發起轉帳。';

  @override
  String get appName => '智記';
  ...
  @override
  String get iosAutoShortcutStep3 => '搜尋並新增「智記 - 截圖自動記帳」操作';

  @override
  String get iosAutoShortcutStep4 => '將「智記」的截圖參數設定為上一步的「截圖」';
  ...
  @override
  String get autoSmsBillingRecognizingTitle => '⏳ 正在辨識簡訊';

  @override
  String get autoNotifyBillingRecognizingTitle => '⏳ 正在識別通知';

  @override
  String get autoNotifyBillingAnalyzingBody => '正在從通知中提取記帳資訊...';

  @override
  String get autoScreenBillingRecognizingTitle => '⏳ 正在辨識帳單頁';

  @override
  String get autoScreenBillingAnalyzingBody => '正在從頁面文字中提取記帳資訊...';

  @override
  String get autoSmsBillingAnalyzingBody => '正在從簡訊中擷取記帳資訊...';

  @override
  String get autoSmsBillingTitle => '簡訊自動記帳';

  @override
  String get autoSmsBillingDesc => '監聽銀行/支付簡訊,用 AI 自動記帳';

  @override
  String get autoSmsBillingDescEnabled => '監聽中,銀行/支付簡訊將自動入帳';

  @override
  String get smsPermissionRequired => '需要「簡訊」權限才能自動記帳';

  @override
  String get autoBillingEntryTitle => '自動記帳';

  @override
  String get autoBillingHealthy => '運行正常';

  @override
  String autoBillingPartial(Object count, Object issues) {
    return '有 $count 項未就緒:$issues';
  }

  @override
  String get autoBillingSmsPermissionMissing => '簡訊權限未授權,自動記帳不完整';

  @override
  String get autoBillingNotifyPermissionMissing => '「通知使用權」未授權,通知自動記帳不完整';

  @override
  String get autoBillingNotifyTitle => '通知自動記帳';

  @override
  String get autoBillingNotifyDesc => '監聽微信/支付寶/銀行 App 支付通知自動記帳';

  @override
  String get autoBillingNotifyDescEnabled => '監聽中,支付通知將自動入帳';

  @override
  String get autoBillingNotifyPermissionTitle => '開啟「通知使用權」';

  @override
  String get autoBillingNotifyPermissionContent => '通知自動記帳需要系統「通知使用權」授權。點擊後跳轉系統設定頁,找到本應用並開啟。';

  @override
  String get autoBillingScreenTextTitle => '明細頁自動記帳';

  @override
  String get autoBillingScreenTextDesc => '監聽支付寶/抖音/京東/微信帳單明細頁,自動記帳';

  @override
  String get autoBillingScreenTextDescEnabled => '監聽中,開啟帳單明細頁將自動入帳';

  @override
  String get autoBillingScreenTextPermissionMissing => '「無障礙」未授權,明細頁自動記帳不生效';

  @override
  String get autoBillingScreenTextVivoHint => 'vivo/iQOO 用戶注意:若開啟後開關自動回彈關閉,請到「設定 → 快捷與輔助 → 無障礙」找到本服務開啟;仍被關閉時,需在「i 管家 → 隱私權限 → 受限設定」中允許本應用,並在「設定 → 電池 → 後台高耗電」中允許智記。';

  @override
  String get autoBillingScreenTextPermissionTitle => '開啟「無障礙服務」';

  @override
  String get autoBillingScreenTextPermissionContent => '明細頁自動記帳需要系統「無障礙」授權。僅讀取支付寶/抖音/京東/微信頁面文字(含金額、商家),用於自動記帳;文字不入日誌、不儲存,處理完即刪。';

  @override
  String get autoBillingHealthIssueScreenshot => '截圖監聽';

  @override
  String get autoBillingHealthIssueSms => '簡訊監聽';

  @override
  String get autoBillingHealthIssueSmsPermission => '簡訊權限';

  @override
  String get autoBillingHealthIssueNotify => '通知監聽';

  @override
  String get autoBillingHealthIssueNotifyListener => '通知使用權';

  @override
  String get autoBillingHealthIssueAiText => 'AI 文字模型';

  @override
  String get autoBillingHealthIssueAiVision => 'AI 視覺模型';

  @override
  String get autoBillingHealthIssueBattery => '電池優化';

  @override
  String get autoStartTitle => '自啟動與後台保活';

  @override
  String get autoStartDesc => 'vivo/OriginOS 等需手動允許自啟動、關閉「後台高耗電」限制、最近任務鎖定 App,否則被清理後收不到簡訊/通知';

  @override
  String get autoStartGo => '去設定';

  @override
  String get autoStartOpened => '已跳轉系統設定,請找到本應用開啟自啟動';

  @override
  String get autoStartOpenFailed => '無法打開廠商設定,請手動在應用詳情頁開啟自啟動';

  @override
  String get channelMappingTitle => '渠道→帳戶映射';

  @override
  String get channelMappingDesc => '簡訊/通知來源(如 招商銀行、支付寶)忽略 AI 帳戶識別,直接記到指定資產帳戶';

  @override
  String get channelMappingAdd => '新增映射';

  @override
  String get channelMappingChannelLabel => '渠道名稱';

  @override
  String get channelMappingAccountLabel => '目標帳戶';

  @override
  String get channelMappingEmpty => '尚無映射規則,新增後自動記帳將按來源渠道入帳';

  @override
  String get channelMappingSaved => '映射已儲存';

  @override
  String get channelMappingDeleted => '映射已刪除';

  @override
  String get autoBillingMockTitle => '手動模擬測試';

  @override
  String get autoBillingMockDesc => '不依賴真實簡訊/通知,注入模擬資料驗證 AI 記帳鏈路是否正常';

  @override
  String get autoBillingMockSms => '模擬簡訊';

  @override
  String get autoBillingMockNotify => '模擬通知';

  @override
  String get autoBillingMockScreen => '模擬螢幕文字';

  @override
  String get autoBillingMockSubmitted => '已提交,處理結果見系統通知';

  @override
  String get autoBillingMockCustom => '自訂內容';
  ...
  @override
  String get pendingConfirmationDesc => '自動記帳中低置信/大額/疑似重複的候選,人工審核';

  @override
  String get pendingConfirmationEmpty => '沒有待確認的記帳';

  @override
  String pendingConfirmationCountBadge(Object count) {
    return '有 $count 筆待確認,點擊審核';
  }

  @override
  String get pendingConfirmationConfirm => '確認入帳';

  @override
  String get pendingConfirmationEdit => '編輯後入帳';

  @override
  String get pendingConfirmationReject => '拒絕';

  @override
  String get pendingConfirmationRejectAsk => '確定拒絕並刪除這條待確認記帳?';

  @override
  String get pendingConfirmationApproved => '已入帳';

  @override
  String get pendingConfirmationRejected => '已拒絕';

  @override
  String get pendingConfirmationEditFailed => '金額無效';

  @override
  String get pendingConfirmationApproveFailed => '入帳失敗';

  @override
  String get pendingConfirmationAmount => '金額';

  @override
  String get pendingConfirmationNote => '備註';

  @override
  String get pendingConfirmationUncheckedReason => '待確認';

  @override
  String get pendingCandidateReasonDuplicate => '疑似重複:近期已有相似交易';

  @override
  String get pendingCandidateReasonLarge => '大額消費';

  @override
  String get pendingCandidateReasonLowConfidence => '低置信度,請核對';
  ...
  @override
  String get autoScreenBillingNoBillTitle => '此頁面未辨識到帳單';

  @override
  String get autoScreenBillingNoBillBody => '頁面未辨識到已成交交易,已跳過';

  @override
  String get autoScreenBillingRecognizeFailedTitle => '❌ 辨識失敗';

  @override
  String get autoScreenBillingRecognizeFailedBody => '無法從頁面文字提取帳單資訊,請檢查 AI 設定';

  @override
  String get autoScreenBillingProcessFailedTitle => '❌ 處理失敗';
  ...
  @override
  String get cloudTutorialIntro => '智記 是可自建的雲同步服務端,支援多裝置即時協同。流程很簡單:';

  @override
  String get cloudTutorialStep1Title => '第一步:部署或選擇伺服器';

  @override
  String get cloudTutorialStep1Desc => '自行部署:Docker 一行指令拉起(詳見 GitHub README 的 Docker 指南)。或直接使用朋友/團隊既有的智記 伺服器。';

  @override
  String get cloudTutorialStep2Title => '第二步:取得帳號';

  @override
  String get cloudTutorialStep2Desc => '智記 不支援自助註冊(避免公網服務被濫用)。自行部署:Docker 首次啟動日誌會印出隨機管理員帳密,直接用。加入他人伺服器:請管理員在 Web 後台 →「使用者」裡為你建立帳號。';

  @override
  String get cloudTutorialStep3Title => '第三步:登入並開啟同步';

  @override
  String get cloudTutorialStep3Desc => 'App 內選「智記」,填伺服器位址 + 管理員給你的帳號,登入。首次會全量上傳你本機所有帳本資料,之後每次編輯即時推送。';
  ...
  @override
  String get shareBillingGuide => '在支付寶、微信、相簿等應用中看到支付截圖時，點擊「分享」並選擇「智記」，即可自動識別金額、商家、時間等資訊並記帳，無需先儲存截圖。';

  @override
  String get shareBillingActionHint => '分享後會在背景自動識別記帳，無需手動開啟智記';
  ...
  @override
  String get aboutDeveloperStory => '從 2015 年實習起，我堅持記帳至今已超過十年。因為擔心記帳軟體的廣告、付費、隱私洩露和停運跑路，我決定自己做一個——最初只是給自己和家人用的小工具。\n\n2025 年 9 月，智記發佈了第一個版本。說實話，那時候心裡沒什麼底，不知道會不會有人用。但慢慢地，開始收到用戶的回饋——有人說終於找到了一款乾淨的記帳軟體，有人提了很好的建議，也有人默默給了五星好評。每一條回饋都讓我覺得，這件事值得繼續做下去。\n\n智記沒有廣告、沒有會員、完全免費開源。你的每一筆資料都只存在你自己的手機裡，不會被上傳到任何第三方伺服器。但上架和維護一款 App 並非零成本——開發者帳號、伺服器等開支目前靠社群捐贈勉強支撐，每一次適配新系統、修復 Bug、開發新功能，也都是工作之餘一點點完成的。\n\n如果你覺得智記對你有幫助，一個好評、一次分享或一筆捐贈，都能讓這個小專案走得更遠。謝謝你的信任。';
  ...
  @override
  String get aboutBeeAssetsIntro => '智記側重日常流水,蜜蜂家當是它的姐妹產品,專注資產配置視覺化:跨帳戶淨資產趨勢、房產 / 投資 / 加密資產分類、收益率與持倉時長、配置占比一目了然。';
  ...
  @override
  String get configExportShareSubject => '智記 配置檔案';
  ...
  @override
  String get donationDescriptionDetail => '感謝您使用智記！如果這個應用對您有幫助，歡迎請開發者喝杯咖啡作為鼓勵。您的支持是我持續改進的動力。';
  ...
  @override
  String donationThankYouMessage(String productName) {
    return '感謝您購買 $productName！您的支持對我意義重大，我會繼續努力改進智記，讓它變得更好用！';
  }
  ...
  @override
  String get tagDefaultSmsBilling => '簡訊';

  @override
  String get tagDefaultNotificationBilling => '通知';

  @override
  String get tagDefaultScreenBilling => '螢幕';
  ...
  @override
  String get tagShareSubject => '智記 標籤配置';
  ...
  @override
  String get iosShortcutStep4 => '貼上上方複製的連結（如 smartbook://voice）';
  ...
  @override
  String get androidShortcutStep3 => '貼上上方複製的連結（如 smartbook://voice）';
  ...
  @override
  String get appLockBiometricReason => '請驗證身份以解鎖智記';
  ...
  @override
  String get sharedInviteInstruction => '把邀請碼或短連結發給對方。對方裝上智記 後,點擊連結或在「我的 → 加入共享帳本」輸入碼即可加入。';

  @override
  String sharedInviteShareText(String ledger, String code, String url) {
    return '邀請你加入智記 共享帳本「$ledger」\n\n邀請碼:$code\n連結:$url\n\n點擊連結或在智記 → 我的 → 加入共享帳本輸入此碼即可。';
  }
